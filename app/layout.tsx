...
import { Geist, Geist_Mono, Noto_Sans, Instrument_Serif } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning className={cn("font-sans", notoSans.variable, instrumentSerifHeading.variable)}>
        <head />
        <body>
          <ThemeProvider
            attribute="class"
