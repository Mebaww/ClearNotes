...
function SectionHeading({
  ...
  return (
    <div className="mx-auto max-w-2xl text-center">
      ...
      <p className="mt-4 text-base leading-relaxed text-[#6E6E73] dark:text-zinc-400">{children}</p>
    </div>
  );
}
  ...
  return (
    <main className="bg-[#F5F5F7] text-[#1D1D1F] dark:bg-[#09090B] dark:text-zinc-50">
      ...
      <section className="relative overflow-hidden border-b border-black/5 px-6 pb-24 pt-32 sm:pb-28 sm:pt-40 lg:px-8 dark:border-white/10">
        {/* subtle ambient wallpaper blobs */}
        ...
        <div className="relative mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1fr_1.1fr] lg:items-center">
          <div className="animate-fade-up">
            <div className="inline-flex items-center gap-2 rounded-full border border-black/5 bg-white/70 px-3.5 py-1.5 text-xs font-medium text-[#6E6E73] shadow-sm backdrop-blur-xl dark:border-white/10 dark:bg-white/5 dark:text-zinc-400">
              <Sparkles className="h-3.5 w-3.5 text-[#B8863B] dark:text-[#E0B568]" />
              Better notes from long documents
            </div>
            ...
            <h1 className="mt-6 max-w-2xl text-4xl font-semibold tracking-tight text-[#1D1D1F] sm:text-5xl lg:text-6xl dark:text-zinc-50">
              ...
              <span className="relative inline-block">
                {/* <span className="absolute inset-x-0 bottom-1.5 h-3 rounded-sm bg-[#B8863B]/20 dark:bg-[#E0B568]/20" /> */}
            ...
            <p className="mt-6 max-w-xl text-base leading-relaxed text-[#6E6E73] dark:text-zinc-400">
              ...
              clean, structured notes you can actually use for work and
              study.
            </p>
            <div className="mt-8">
            ...
            <div className="mt-10 grid max-w-lg grid-cols-3 gap-3 text-sm">
              <div className="rounded-xl border border-black/5 bg-white/60 px-3.5 py-3 backdrop-blur-xl dark:border-white/10 dark:bg-white/5">
                <p className="font-semibold text-[#1D1D1F] dark:text-zinc-50">PDFs</p>
                <p className="mt-0.5 text-xs text-[#86868B] dark:text-zinc-500">Reports & studies</p>
              </div>
              <div className="rounded-xl border border-black/5 bg-white/60 px-3.5 py-3 backdrop-blur-xl dark:border-white/10 dark:bg-white/5">
                <p className="font-semibold text-[#1D1D1F] dark:text-zinc-50">Slides</p>
                <p className="mt-0.5 text-xs text-[#86868B] dark:text-zinc-500">Decks & pitchbooks</p>
              </div>
              <div className="rounded-xl border border-black/5 bg-white/60 px-3.5 py-3 backdrop-blur-xl dark:border-white/10 dark:bg-white/5">
                <p className="font-semibold text-[#1D1D1F] dark:text-zinc-50">Docs</p>
                <p className="mt-0.5 text-xs text-[#86868B] dark:text-zinc-500">Briefs & manuals</p>
              </div>
            </div>
          </div>

          {/* macOS-style window mockup */}
          <div className="relative animate-fade-up pt-6 pr-6">
                ...
                <div className="mt-5 border-t border-black/5 pt-5 dark:border-white/10">
                  ...
                  <div className="mt-3 space-y-3">
                    <div className="flex gap-3">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-[#1D1D1F] dark:text-zinc-50">Key takeaways</p>
                        <p className="mt-0.5 text-xs leading-relaxed text-[#6E6E73] dark:text-zinc-400">
                          Three financial goals met; product timeline confirmed for launch.
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-[#1D1D1F] dark:text-zinc-50">Organized sections</p>
                        <p className="mt-0.5 text-xs leading-relaxed text-[#6E6E73] dark:text-zinc-400">
                          Action items, timelines, and risk flags extracted and grouped.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="absolute -top-2 right-0 hidden items-center gap-3 rounded-2xl border border-black/5 bg-white/90 px-4 py-3 shadow-xl shadow-black/10 backdrop-blur-xl sm:flex dark:border-white/10 dark:bg-zinc-900/90 dark:shadow-black/40">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#B8863B]/12 text-[#B8863B] dark:bg-[#E0B568]/15 dark:text-[#E0B568]">
                <Sparkles className="h-4.5 w-4.5" />
              </div>
              <div>
                <p className="text-xs font-semibold text-[#1D1D1F] dark:text-zinc-50">ClearNotes</p>
                <p className="text-xs text-[#6E6E73] dark:text-zinc-400">3 new notes ready</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="border-b border-black/5 bg-[#FBFBFD] px-6 py-20 sm:py-24 lg:px-8 dark:border-white/10 dark:bg-[#0F0F11]">
        <SectionHeading eyebrow="How it works" title="Simple from upload to notes">
        ...
        <div className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-3">
          {steps.map((step) => (
            ...
            >
              <div className={`flex h-12 w-12 items-center justify-center rounded-xl ${chipClass(step.accent)}`}>
                <step.icon className="h-6 w-6" strokeWidth={2.25} />
              </div>
              <h3 className="mt-5 text-lg font-semibold text-[#1D1D1F] dark:text-zinc-50">{step.title}</h3>
              <p className="mt-2 text-sm leading-relaxed text-[#6E6E73] dark:text-zinc-400">{step.text}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* Features Showcase */}
      <section id="features" className="border-b border-black/5 bg-[#F5F5F7] px-6 py-20 sm:py-24 lg:px-8 dark:border-white/10 dark:bg-[#09090B]">
        <SectionHeading eyebrow="Why people like it" title="Designed to feel effortless">
        ...
        <div className="mx-auto mt-12 grid max-w-5xl gap-6 md:grid-cols-2">
          {features.map((feature) => (
            ...
            >
              <div className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-xl ${chipClass(feature.accent)}`}>
                <feature.icon className="h-5.5 w-5.5" strokeWidth={2.25} />
              </div>
              <div>
                <h3 className="text-base font-semibold text-[#1D1D1F] dark:text-zinc-50">{feature.title}</h3>
                <p className="mt-1.5 text-sm leading-relaxed text-[#6E6E73] dark:text-zinc-400">{feature.text}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      {/* Waitlist Section */}
      <section id="waitlist" className="relative overflow-hidden bg-[#FBFBFD] px-6 py-20 sm:py-24 lg:px-8 dark:bg-[#0F0F11]">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="relative mx-auto max-w-3xl rounded-3xl border border-black/5 bg-white p-8 text-center shadow-sm sm:p-16 dark:border-white/10 dark:bg-white/[0.03]">
          ...
          <div className="mt-8 flex justify-center">
            <WaitlistForm variant="light" size="large" buttonLabel="Get early access" />
          </div>
        </div>
      </section>
